...
data = pd.read_excel('Training_Data.xlsx', sheet_name='Blood-LL_tissue')
...
#%% load testing data
test_data = pd.read_excel('Testing_Data.xlsx', sheet_name='Blood-LL_tissue')
...
if save_results:
    file = open("Neutrophils_Mapping_Results_"+figname+".txt","a")
